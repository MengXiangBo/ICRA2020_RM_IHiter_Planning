...
if("TRUE" STREQUAL "TRUE")
  set(qtros_SOURCE_PREFIX /home/dengxin/icra2020/src/qtros)
  set(qtros_DEVEL_PREFIX /home/dengxin/icra2020/devel)
  set(qtros_INSTALL_PREFIX "")
  set(qtros_PREFIX ${qtros_DEVEL_PREFIX})
else()
  set(qtros_SOURCE_PREFIX "")
  set(qtros_DEVEL_PREFIX "")
  set(qtros_INSTALL_PREFIX /home/dengxin/icra2020/install)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'dengxin <dengxin@gmail.com>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'qtros' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/dengxin/icra2020/src/qtros/${idir}'.  ${_report}")
    endif()
